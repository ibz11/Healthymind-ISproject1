...
<a class="m-2 btn btn-warning" href="{{URL('posts')}}">Back</a>
<div class="mt-5 d-flex justify-content-center">
    
<div class="m-3">
<span class="badge bg-danger">Role</span>
 
     <h1 class="display-1">Reply from : </h1>
    
     <p class="h5">Lorem ipsum dolor sit amet consectetur adipisicing elit.
          Quam repudiandae iste voluptatem officia provident praesentium 
          minima labore? Molestiae, rerum recusandae.</p>
    </div>
</div>
</body>
