...
<h1 class="mt-4 text-2xl"><strong>Update Category</strong></h1>
<form action="{{URL('updatecategory',$category->id)}}" method="POST" id="editform" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
...
<input   type="text" class="form-control w-50" id="name" value="{{$category->user_name}}" name="user_name">
@else
...
<input  readonly type="text" class="form-control w-50" id="name" value="{{$category->user_name}}" name="user_name">
@endif
</div>
<div class="mb-3">
    <label for="pwd" class="form-label">Category Name</label>
    <input   type="text" class="form-control w-50" id="name" value="{{$category->category_name}}" name="category_name">
</div>


<!---Hidden so that user may not edit them-->
<div hidden  class="mb-3">
    <label for="pwd" class="form-label">Category ID</label>
    <input  readonly type="text" class="form-control w-50" id="name" value="{{$category->id}}" name="category_id">
</div>

<div hidden  class="mb-3">
    <label for="pwd" class="form-label">User id</label>
    <input  readonly type="text" class="form-control w-50" id="name" value="{{$category->user_id}}" name="user_id">
</div>
...
<div hidden class="mb-3">
    ...
    <input  readonly  type="text" class="form-control w-50" id="name" value="{{$category->role}}" name="role">
</div>
