...
<h1 class="mt-4 text-2xl"><strong>Create Post</strong></h1>
<form action="{{URL('createpost')}}" method="POST" id="editform" enctype="multipart/form-data">
    @csrf

<div hidden class="mb-3">
    <label for="pwd" class="form-label">Thread ID</label>
    <input readonly  type="text" class="form-control w-50" id="" value="{{$thread->id}}" name="thread_id">
</div>
<div hidden class="mb-3">
    <label for="pwd" class="form-label">User ID</label>
    <input readonly  type="text" class="form-control w-50" id="" value="" name="user_id">
</div>
<div class="mb-3">
    <label for="pwd" class="form-label">Category name</label>
    <input  readonly type="text" class="form-control w-50" id="" value="{{$thread->category_name}}" name="category_name">
</div>
<div hidden class="mb-3">
    <label for="pwd" class="form-label">Thread name</label>
    <input  readonly type="text" class="form-control w-50" id="" value="{{$thread->thread_name}}" name="thread_name">
</div>
<div class="mb-3">
    <label for="pwd" class="form-label">Post name</label>
    <input   type="text" class="form-control w-50" id="" value="" name="post_name">
</div>
<div class="mb-3">
    <label for="pwd" class="form-label">Description</label>
    <input   type="text" class="form-control w-50" id="description" value="" name="description">
</div>
<div class="mb-3">
