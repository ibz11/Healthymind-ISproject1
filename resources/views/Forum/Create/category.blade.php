...
@if (session()->has('message'))
   ...
   @endif
<a class="btn btn-warning" href="{{URL('forum')}}">Back</a>
<h1 class="mt-4 text-2xl"><strong>Create Category</strong></h1>
<form action="{{URL('createcategory')}}" method="POST" id="editform" enctype="multipart/form-data">
    @csrf
